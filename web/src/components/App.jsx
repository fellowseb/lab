...
class App extends React.PureComponent {
  constructor(props) {
    ...
    this.sectionAnchorMountedAbout = partial(this.sectionAnchorMounted, [
      "about",
    ]);
    this.sectionAnchorMountedBrainfuel = partial(this.sectionAnchorMounted, [
      "brainfuel",
    ]);
    this.sectionAnchorMountedLabo = partial(this.sectionAnchorMounted, [
      "labo",
    ]);
  ...
  updateCurrentSection() {
    ...
    var mostVisiblePage = Array.prototype.map
      .call(
    ...
    if (
      ...
      this.state.currentSection !== mostVisiblePage.section
    ) {
      this.setState({
